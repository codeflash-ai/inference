...
def retrieve_init_parameters_values(
    ...
    for block_init_parameter in block_init_parameters:
        ...
        if full_parameter_name in explicit_init_parameters:
            result[block_init_parameter] = explicit_init_parameters[full_parameter_name]
        elif full_parameter_name in initializers:
            result[block_init_parameter] = call_if_callable(
                initializers[full_parameter_name]
            )
        elif block_init_parameter in explicit_init_parameters:
            result[block_init_parameter] = explicit_init_parameters[
