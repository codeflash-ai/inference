...
# Static block list for faster access; instantiate once at module level.
_BLOCKS: List[Type[WorkflowBlock]] = [
    AbsoluteStaticCropBlockV1,
    DynamicCropBlockV1,
    DetectionsFilterBlockV1,
    DetectionOffsetBlockV1,
...
def load_blocks() -> List[Type[WorkflowBlock]]:
    # Return a new shallow copy of the static block list for safety, same behavior as before.
    return _BLOCKS.copy()
