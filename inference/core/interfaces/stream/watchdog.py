...
def compute_events_latency(
    ...
    # Inline are_events_compatible for reduced function call overhead and to exploit short-circuiting
    if (
    ...
    # Timedelta arithmetic and total_seconds is already efficient
